...
class GraduationValidationResult:
    """
    Kết quả kiểm tra dữ liệu xét tốt nghiệp.
    """
...
class GraduationDataValidator:
    """
    Kiểm tra cấu trúc và chất lượng dữ liệu đầu vào.

    Các cột điều kiện tốt nghiệp không được viết
    cứng trong validator mà được truyền vào từ
    GraduationRuleSet.
    """
    ...
    def validate(
        ...
        *,
        ...
        """
        Kiểm tra DataFrame sau khi đã chuẩn hóa tên cột.

        required_rule_fields được lấy từ bộ luật
        tốt nghiệp hiện đang được sử dụng.
        """
